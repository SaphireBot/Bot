...
export default {
    ...
    helpData: {
        description: 'Jogo para adivinhar a sequência',
    },
    async execute({ interaction, Database, client }) {
        ...
        const collector = msg.createMessageComponentCollector({
            ...
            .on('end', (_, r) => {
                Database.Cache.General.pull(`${client.shardId}.sequencyGame`, channel.id)
