...
export default async (interaction, guildData, giveawayId = false) => {
    ...
    if (!giveaway)
        return await interaction.reply({ content: `${e.Deny} | Nenhum sorteio foi encontrado.`, ephemeral: true })
